...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        data = dataOfJson("http://almapp.com/swiftapp/serviceselect.php")
        println(data)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.friendInfo!.text = maindata["age"] as String
        return cell
    }
    
    @IBAction func uploadToDatabase() {
        var url: NSString = "http://almapp.com/swiftapp/servicequery.php?x=\(inputFriendName.text)&y=\(inputFriendInfo.text)"
